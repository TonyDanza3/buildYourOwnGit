...
public class Init extends Command {
    ...
    private void initializeRepo() {
        ...
        fileSystem.replaceFileContents(Path.of(fileSystem.currentDirectory + "/" + HEAD_FILE_SUBDIR), HEAD_FILE_TEMPLATE);
        fileSystem.replaceFileContents(Path.of(fileSystem.currentDirectory + "/" + CONFIG_FILE_SUBDIR), CONFIG_FILE_TEMPLATE);
        fileSystem.replaceFileContents(Path.of(fileSystem.currentDirectory + "/" + DESCRIPTION_FILE_SUBDIR), DESCRIPTION_FILE_TEMPLATE);
